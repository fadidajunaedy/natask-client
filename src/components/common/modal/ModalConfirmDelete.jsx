...
const deleteFunctionMap = {
    EMPLOYEE: async () => (await (import("../../../services/employeeService"))).deleteEmployee,
    TASK: async () => (await import("../../../services/taskService")).deleteTask,
    SUBTASK: async () => (await import("../../../services/subtaskService")).deleteSubtask
}
...
const ModalConfirmDelete = () => {
    ...
    return (
        ...
        <div className="flex flex-col gap-4">
            <Heading level="h2" size="2xl" align="center">Delete Confirmation</Heading>
            <p className="text-center">Are you sure you want to delete this data?</p>
            <Button level="primary" onClick={handleDelete} className="w-full" loading={loading}>
                Confirm
            </Button>
        </div>
        </>
